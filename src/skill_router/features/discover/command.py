...
CAPABILITIES: tuple[dict[str, Any], ...] = (
    ...
    {
        "name": "cheap-llm",
        "purpose": "Local-first bounded extraction, classification, and signal distillation.",
        "cost": "cheap-variable",
        "writes": "cache only",
        "network": "optional provider fallback",
        "start": "cheap-llm --probe",
    },
    {
        "name": "web-research",
        "purpose": "Current search, source reading, and cited research through local-first backends.",
        "cost": "cheap-expensive",
        "writes": "cache only",
        "network": "yes",
        "start": "web-research capabilities",
    },
    {
        "name": "fusion-local",
        "purpose": "Subscription-first multi-model blind-spot and coverage analysis.",
        "cost": "variable",
        "writes": "no",
        "network": "subscription workers; PAYG fallback by policy",
        "start": "fusion-local --capabilities",
    },
    {
        "name": "smart-trim",
